...
export const projects = [
  {
    ...
    impact: [
      "Real-time ranking updates using streaming pipeline (Kafka → Flink → Redis)",
      "Built end-to-end event-driven architecture with fault tolerance",
      "Implemented A/B testing with deterministic hashing and CTR tracking"
    ],
    tech: ["Node.js", "Kafka", "Apache Flink", "Redis", "Distributed Systems", "Event-Driven Architecture", "A/B Testing"],
    architecture: "Browser → Collection API → Kafka → Flink → Redis → Search API → Ranked Results",
    demo: "https://aruthrasathishkumar.github.io/Real-time-Search-Ranking-System/",
