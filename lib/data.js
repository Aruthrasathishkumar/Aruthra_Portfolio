...
export const projects = [
  ...
  {
    id: "voice-qa",
    title: "Anonymous Multi-Language Voice Q&A Platform",
    subtitle: "Distributed Systems | Fastify · Kafka · Redis · WebSockets",
    description: "A multilingual, real-time voice Q&A system enabling anonymous interactions with sub-100ms updates via event-driven architecture.",
    impact: [
      "Sub-100ms real-time updates",
      "500+ concurrent users",
      "Supports 30+ languages"
    ],
    tech: ["Next.js", "Fastify", "OpenAI API", "DeepL API", "Kafka", "Web Sockets", "PostgreSQL"],
    architecture: "Users → Fastify → Kafka → Whisper/DeepL → Redis → WebSockets → Live Q&A",
