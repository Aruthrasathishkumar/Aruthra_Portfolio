...
export const whatIWant = {
  ...
  description: "Actively seeking Softwrae Engineering and AI/ML roles:",
  roles: [
...
export const skills = [
  {
    ...
    items: [
      ...
      "AI/ML engineering",
      "Agentic AI systems & tool orchestration"
    ]
  },
  {
    ...
    items: [
      ...
      "MCP (Model Context Protocol), pgvector semantic search"
    ]
  },
  {
    title: "Backend & Web",
...
export const projects = [
  {
    ...
    subtitle: "AI Infrastructure | Python · MCP · Kubernetes · Postgres",
    description: "An agentic AI incident response platform where Claude Desktop orchestrates 12 MCP tools to investigate, diagnose, and safely remediate production outages across Kubernetes infrastructure - with cryptographic human-in-the-loop approval and auto-generated postmortems.",
    impact: [
      "6x faster incident triage via agentic AI",
      "12 MCP tools across 4 real data sources",
      "100% AI actions gated by HMAC approval"
    ],
    tech: ["Python", "MCP", "PostgreSQL + pgvector", "Kubernetes", "Prometheus", "Loki", "Terraform"],
    architecture: "Claude Desktop → MCP Server → Event Store ← Collectors (GitHub · K8s · Slack · PagerDuty) → Runbooks + HMAC Approval → Safe Remediation",
    github: "https://github.com/Aruthrasathishkumar/Watchtower-MCP-server-for-incident-response"
  },
  {
