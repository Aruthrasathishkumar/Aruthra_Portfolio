...
export const projects = [
  ...
  },
  {
    ...
    subtitle: "Backend Systems | React · Node.js · Express · PostgreSQL · JWT",
    description: "A Bitly-style URL shortener that lets users create custom short links, track click analytics, and manage links from a secure dashboard.",
    impact: [
      "Persistent link management with custom slugs and expiration",
      "Click analytics with referrer, device, and geo tracking",
      "Abuse-resistant backend with rate limiting"
    ],
    tech: ["React", "Node.js", "Express", "PostgreSQL", "JWT", "Tailwind CSS", "Rate Limiting"],
    architecture: "Browser → Authenticated dashboard (React, JWT) → Link service (Node.js/Express) → PostgreSQL (short code + metadata) → redirect responses. Click events → analytics collector → aggregated stats tables powering charts in the dashboard.",
  ...
  },
  {
    ...
    description: "A full-stack dashboard to track job applications, statuses, contacts, and deadlines with a Kanban-style workflow.",
    impact: [
    ...
    tech: ["React", "Node.js", "Express", "PostgreSQL", "JWT", "Cron Jobs", "CSV Export"],
    architecture: "Client (React) → API layer (Node.js) → PostgreSQL for applications, companies, contacts, and notes. Background scheduler (cron) scans upcoming deadlines and triggers reminders, while the UI renders applications in a Kanban board with drag-and-drop state transitions.",
...
export const experiences = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "REFACTORED backend into reusable Python modules → 30% faster feature rollout & 25% fewer production bugs.",
